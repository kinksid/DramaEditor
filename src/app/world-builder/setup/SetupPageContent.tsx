        ...
        <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-soft">
          <div className="flex flex-wrap items-center justify-between gap-4">
            <div>
              ...
              {activeProjectId && (
                <p className="mt-1 text-xs text-slate-400">项目 ID：{activeProjectId}</p>
              )}
            </div>
        ...
        {step === 3 && (
          <section className="mt-5 rounded-3xl border border-slate-200 bg-white p-8 text-center shadow-soft">
            ...
            <div className="mt-6 flex justify-center gap-3">
              ...
              <button onClick={handleOpenStoryGraph} className="rounded-xl bg-accent px-5 py-2 text-sm font-semibold text-white">
                打开故事图
              </button>
            </div>
          </section>
