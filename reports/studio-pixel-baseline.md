...
更新时间：2026-07-21 21:10 Asia/Shanghai

## 证据边界

- 2026-07-21 浏览器核验：`https://studio.dreem-world.ai/`、`/worlds`、`/worlds/example/characters`、`/worlds/example/locations`、`/worlds/example/storylines` 与 `/stories/example` 均在展示产品内容前进入 `/sign-in`。
- 登录墙可确认 Creator Studio 品牌区及 Apple、Google、邮箱登录入口；无法确认登录后的世界卡片、详情标签或故事控件。
