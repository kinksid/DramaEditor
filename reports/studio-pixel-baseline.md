...
更新时间：2026-07-21 20:35 Asia/Shanghai

## 证据边界

- 2026-07-21 浏览器核验：`https://studio.dreem-world.ai/`、`/worlds`、`/worlds/example/characters` 与 `/stories/example` 均在展示产品内容前重定向到 `/sign-in`。
- 登录墙可确认左右分栏结构、品牌插画区与 OAuth/邮箱登录区；无法确认登录后的世界卡片、详情标签或故事控件。
